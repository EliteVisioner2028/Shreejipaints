...
const MainCategoryCard = ({ category, onClick }) => {
  ...
  return (
    ...
    >
      ...
      {/* Click Here Label - Always visible, positioned like in the image */}
      <div className="absolute top-3 right-3 bg-[#88022f] text-white text-xs px-3 py-1 rounded-full shadow-lg border-2 border-white z-10">
        <span className="font-semibold">Click Here</span>
      </div>
